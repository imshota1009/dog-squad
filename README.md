...
**👨‍💻 開発体制:** 本作は4人のチームメンバーが協力して制作したプロジェクトです。
代表者（[imshota1009](https://github.com/imshota1009/imshota1009)）は過去にビジネスコンテストでの入賞経験があり、本プロジェクトもその企画力やユーザー目線（ビジネス視点）を活かしてゲームバランスやAIの設計を行っています。
...
**👨‍💻 Development Team:** This project was developed in collaboration by a team of 4 members.
The team leader ([imshota1009](https://github.com/imshota1009/imshota1009)) has experience winning a business contest, and this project leverages that planning ability and business perspective in its game balance and AI design.
